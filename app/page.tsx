...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-between relative bg-base overflow-x-hidden pb-24 md:pb-6">
      ...
      {/* Hero Section */}
      <section className="relative w-full h-[60vh] md:h-[50vh] flex flex-col items-center justify-center text-center px-6 border-b border-white/[0.04] bg-gradient-to-b from-surface/40 to-transparent">
        ...
        <div className="relative z-10 max-w-3xl flex flex-col items-center">
          ...
          <motion.div
            ...
            className="mb-4 px-3 py-1 rounded-full bg-accent-teal/10 border border-accent-teal/20 text-xs font-mono font-bold text-accent-teal tracking-widest uppercase shadow-[0_0_15px_rgba(0,229,196,0.15)]"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-extrabold font-display text-text-primary tracking-tight uppercase leading-none mb-6"
          >
            FIRST AID. <span className="text-accent-teal drop-shadow-[0_0_15px_rgba(0,229,196,0.3)]">FAST.</span> RIGHT.
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-text-muted max-w-xl font-medium leading-relaxed font-sans"
          >
