export interface FirstAidStep {
  ...
  title: string;
  description: string;
  imagePrompt: string; // used for placeholder image alt/description
  warning?: string;
}

export interface FirstAidType {
  id: string;
  name: string;
  bodyPart?: string;
  severity: 'mild' | 'moderate' | 'severe';
  overview: string;
  formula: { acronym: string; steps: string[] }; // e.g. RICE = Rest, Ice, Compress, Elevate
  steps: FirstAidStep[];
  doNots: string[];
...
export interface FirstAidCategory {
  ...
  description: string;
  formula: string; // e.g. "D.R.I" or "R.I.C.E"
